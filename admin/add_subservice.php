...
if(isset($_POST['upload'])){
    ...
    $subser_id = $_POST['subser'];
    $image = $_FILES['image'];
    $file_tmp = $_FILES['image']['tmp_name'];
    $file = $_FILES['image']['name'];
    $subser_image = "../uploads/".$file;
    move_uploaded_file($file_tmp,"../uploads/".$file);
    mysqli_query($conn,"INSERT INTO subservices_tbl(service_id, subser_img) VALUES('$subser_id','$subser_image')");
                ...
                <form action="" method="POST" enctype="multipart/form-data" >
                        <div class="row">
                            <div class="col-md-8 mb-1">
                                <select class="form-control" name="subser">
